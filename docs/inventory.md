...
|------|--------|------------|--------|
| check-media | TalkBank/check-media *(planned)* | talkbank-dev/scripts/check-media/ | **In progress** — Rust; CHAT ↔ media validation with cached manifest; replaces staging/chatmedia.py; Phase 3 pre-push hook |
